class UpdateTeamBusinessSettingService
  ...
  def call
    ...
    ServiceResult.new(success: true, resource: nil, message: I18n.t("services.update_team_business_setting_service.success"))
  ...
  def failure_result
    ServiceResult.new(success: false, resource: nil, message: I18n.t("services.update_team_business_setting_service.failure"))
  end
end
