module Services
  class UpdateStaffProfile
    ...
    def call
      ...
      Result.new(success: true, resource: @form, message: I18n.t("services.staff_profile_update_service.success"))
    ...
    def failure_result
      Result.new(success: false, resource: @form, message: I18n.t("services.staff_profile_update_service.failure"))
    end
  end
end
